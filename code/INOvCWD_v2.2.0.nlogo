...
[
  ...
  aet-raster ;20220523. Stores raster with artificial ecological trap patches.
...
[
  ...
  drz ;20220503. Determines whether patch is in deer reduction zone patch.
  aet ;20220523. Determines whether patch is in artificial ecological trap.
  ]
breed [ deers deer ]
deers-own
[
...
;  ]
  ...
  file-close
  reset-aet-drz-counters ;20220520. Set AET/DRZ counters to zero
end
;------------------------------------------------------------
to setup-landscape
...
;20220523. Procedure to set value of aet patch variable. If raster present, values set to 0 or 1. If raster absent, values set to 0.
to setup-aet
  ifelse file-exists? "../data/kankakee_aet_20220523.asc" = true
  [
    set aet-raster gis:load-dataset "../data/kankakee_aet_20220523.asc"
    gis:apply-raster aet-raster aet
  ]
  [
    ask patches [
      set aet 0
...
;----------------------------deer mating submodel----------------
  ...
  if (d = 12) [
    ...
    file-print""
    file-close
    update-aet-drz-output ; 20220504. Writes the AET counters for the year to the output file.
    reset-aet-drz-counters; 20220520. Reset AET/DRZ counters to zero
    ]
  set ndd 0
...
to hunting-mortality-mf12
  ;20220523. Tracks mortality in AET and DRZ in output
  (ifelse
